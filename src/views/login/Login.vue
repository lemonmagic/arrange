<!--
 * @FileDescription: 服务编排登录页面
 * @Author: Lemon_Magic
 * @Date: 2022-03-04 15:22:19
 -->
<template>
  <div id="login">
    ...
    <div class="container" v-show="show">
      ...
      <div class="desc-warp">
        <div class="desc-warp-item sign-up-desc">
          ...
          <img src="../../assets/img/login/signin.svg" alt="" />
        </div>
        <div class="desc-warp-item sign-in-desc">
          <div class="content">
            <button id="sign-in-btn" @click="singInBtn">登录</button>
          </div>
          <img src="../../assets/img/login/signup.svg" alt="" />
        </div>
      </div>
    </div>
    </transition>
...
export default {
  ...
  data() {
    return {
      loginUsername: "A22-InsideBlow",
      loginPassword: "insideBLOW",
      show: true,
    };
  },
  methods: {
    ...
    /**
     * @description: 点击登录后向后端请求，发送用户名和密码两个参数，后台返回是否允许登录
     * @param {void}
     * @return {void}
     */
    /**
     * TODO: request请求；返回值判断：成功则保存token到sessionStorage跳转编排首页，否则提示登录失败（用户名密码错误或请求超时）
     */
    login() {
      // 通过路由导航跳转到/home
      this.show = !this.show;
